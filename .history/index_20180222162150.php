  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-6">Email</div><div class="col-6"><input type="text" name="email" class="form-control" /></div>
            <div class="col-6">Password</div><div class="col-6"><input type="text" name="password"  class="form-control"/></div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <button onclick="login()" type="button" class="btn btn-primary">login</button>
        <a  class="btn btn-default">No Account? Register</button>
      </div>
    </div>
  </div>
</div>
