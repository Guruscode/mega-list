  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-6" id="name-box-1">Name</div><div class="col-md-6" id="name-box-2"><input type="text" name="email" class="form-control" /></div>
      ...
      <div class="modal-footer">
        ...
        <div id="account-notice"><a class="btn btn-default"  onclick="switchForm('lf')">No Account? Register</button></div>
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    function switchForm(n){
        ...
        if(n == 'rf'){
            ...
            $("#name-box-1").hide();
            $("#name-box-2").hide();
            $("#account-notice").html("a class='btn btn-default'  onclick='switchForm(1)'>No Account? Register</button>");
            ...
            $("#name-box-1").show();
            $("#name-box-2").show();
            $("#account-notice").html("a class='btn btn-default'  onclick='switchForm(2)'>Have Account? Login</button>");
