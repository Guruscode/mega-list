...
<body>
        ...
        <div class="container h-100">
            ...
            <div class="col-12 my-auto">
                ...
                <p class="mb-5">Welcome to a place for adding and viewing store lists, here you can do two things, 1. Add store 2. View Store</p>
                <div class="input-group input-group-newsletter">
                    ...
                    <a class="btn btn-secondary" type="button">List Stores</a>
                    </div>
                </div>
                </div>
            </div>
