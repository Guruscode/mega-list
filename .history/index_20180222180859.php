...
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" id="add_modal" data-toggle="modal" data-target="#exampleModalCenter">
  Launch
</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-6" id="name-box-1">Store Name</div><div class="col-md-6" id="name-box-2"><input type="text" id="name" class="form-control" /></div>
